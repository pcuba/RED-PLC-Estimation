...
mhrun     = 1;   # mhrun=1 for 22000 draws and mhrun=2,3 for 55000 draws
nM        = 1000; # number of particles
ME_scale  = 0.15;
nSimRWMH  = 22000; # either 22000 or 55000
nBurnRWMH = 2000;  # either 2000 or 5000
silent    = 1;
nOutput   = 100;  # print output every nOutput (>1) steps (use = 0 to print each step)
c         = 0.1;  # scaling of proposal covariance matrix
                  # mhrun=1,2 for c=0.1 and mhrun=3 for c=0.005
...
include(readDir * "run_MCMC_BSPF.jl")
...
nFileStrMH = "BSPF_" * nNamePriorSpec * "_" * nDataSet * "_Mhrun" *"$(mhrun)"
...
run_MCMC_BSPF(ME_scale, nM, nSimRWMH, mhrun, nBurnRWMH,
